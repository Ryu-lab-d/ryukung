-- เพิ่มเลขพร้อมเพย์ของร้านและยอดที่จ่ายไปแล้ว/ยอดคงเหลือ ให้หน้าลูกค้าใช้สร้าง QR พร้อมเพย์แบบล็อกยอดคงเหลือได้
-- (ล็อกยอดคงเหลือ ไม่ใช่ยอดเต็มออเดอร์ เผื่อลูกค้ามัดจำมาแล้วบางส่วน กัน scan จ่ายซ้ำเกินยอดที่ต้องจ่ายจริง)
